...
class PShape:
    ...
    @overload
    def setFill(self, v1: float, v2: float,
                v3: float, _alpha: float) -> None: ...
    ...
    @overload
    def setStroke(self, v1: float, v2: float,
                  v3: float, _alpha: float) -> None: ...
...
def bezierTangent(a: float, b: float, c: float,
...
def curveTangent(a: float, b: float, c: float,
                 d: float, t: float) -> float: ...
...
@overload
def bezierVertex(x2: float, y2: float, x3: float, y3: float,
...
@overload
def quadraticVertex(cx: float, cy: float, cz: float,
...
@overload
def applyMatrix(n00: float, n01: float, n02: float, n10: float,
                n11: float, n12: float) -> None: ...
...
@overload
def ambientLight(v1: float, v2: float, v3: float,
                 x: float, y: float, z: float) -> None: ...


def directionalLight(v1: float, v2: float, v3: float,
...
def pointLight(v1: float, v2: float, v3: float,
               x: float, y: float, z: float) -> None: ...
...
@overload
def colorMode(mode: int, max1: float, max2: float,
              max3: float, maxA: float) -> None: ...
...
def blendColor(c1: Union[Color, int],
               c2: Union[Color, int], MODE: int) -> None: ...
...
def lerpColor(c1: Union[Color, int],
              c2: Union[Color, int], amt: float) -> Color: ...
...
@overload
def blend(src: PImage, sx: int, sy: int, sw: int, sh: int, dx: int,
          dy: int, dw: int, dh: int, mode: int) -> None: ...
...
@overload
def copy(src: PImage, sx: int, sy: int, sw: int, sh: int,
...
@overload
def createFont(name: str, _size: float, _smooth: bool,
               charset: list) -> None: ...
...
@overload
def map(value: float, start1: float, stop1: float,
        start2: float, stop2: float) -> float: ...
